    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="h-screen relative flex flex-col items-center justify-center">
                <div className="font-ocr text-5xl sm:text-7xl md:text-8xl tracking-wider drop-shadow-2xl drop-shadow-primary/40">SUBSPACE</div>
                <div className="font-freecam tracking-wider text-xs sm:text-sm md:text-lg mt-2.5 drop-shadow-xl">Intergalactic Communicator</div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center gap-2 my-52 pb-14">
                {(() => {
                    const Btn = <Button className="z-20 p-10 drop-shadow-2xl tracking-wider px-12 bg-primary text-primary-foreground hover:bg-primary-foreground font-ocr
            ...
            <div className="flex flex-col text-black bg-primary w-full p-6 gap-4 font-ka">
                <div className="flex flex-col items-center text-center justify-center gap-2 opacity-70">
                    <div className="tracking-widest">powered by <Link draggable={false} target="_blank" to="https://x.com/aoTheComputer" className="hover:underline underline-offset-8 hover:text-white">aoTheComputer</Link></div>
                </div>
                {/* @ts-ignore */}
                <div className="text-xs text-center opacity-50">v{__VERSION__}</div>
            </div>
        </div>
    )
}
